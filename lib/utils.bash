...
# NOTE: You might want to remove this if bitrise is not hosted on GitHub releases.
...
list_all_versions() {
  ...
  # Change this function if bitrise has other means of determining installable versions.
  list_github_tags
}
...
install_version() {
  ...
  (
    ...
    # TODO: Asert bitrise executable exists.
    local tool_cmd
